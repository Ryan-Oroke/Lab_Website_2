...
*/
	...
	function loadPlayersPage(){
		//Variables
		//theA = Anchor
		//theDiv = <div> tag where modification occurs
		for(var p = 0; p < players.length; p++){
			console.log(players[p].name);
			var theDiv = document.getElementById("player_selector")
			var theA = document.createElement('a');
			theDiv.appendChild(theA);
			theA.href="#";
			theA.innerHTML=players[p].name;
			theA.className="dropdown-item";
			theA.index=p;
			theA.onclick=function(){switchPlayers(this.index);}
		}
	}
